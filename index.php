...
<head>
		<meta charset="utf-8">
        <title>New Work Informática</title>
...
<body>
	...
	<header>
		<nav class="navbar navbar-default">
			<div class="container" id="top">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#">New Work Informática</a>
				</div>
		...
		<div class="container newWork-bannerWrapper">
			<div class="newWork-banner">
				<h1>New Work Informática</h1>
				<p>Resolvendo os seus problemas desde 2000 A.C</p>
    ...
    <section id="depoimentos">
        ...
        <h2 class="container titulo-depoimentos">Nossos Serviços</h2>
        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <figure class="item active">
                    <img src="assets/img/consultoria-banner.jpg" alt="Depoimento 1">
	...
	<section id="sobre-nos" class="container">
		<h2>Sobre Nós</h2>
		<div class="row">
			<img class="img-responsive col-sm-6" src="assets/img/logo.png" alt="">
		...
		<div class="row">
				...
				<figure class="thumbnail">
					...
					<figcaption class="caption">
						<h3>Casa Castelo</h3>
						<p>
							A Casa Castelo é o último lançamento da newWork Arquitetura, feita para um monge.
						</p>
					</figcaption>
				</figure>
			</div>
    ...
    <div class="right">
        <a id="back-top" class="btn-arriba" href="#top">Volver arriba</a>
    </div>

	<footer>
		<address>
			<strong>New Work Informática</strong><br>
			Rua Vergueiro, 3185, Vila Mariana<br>
			São Paulo, SP<br>
			Tel: (11) 5571-2751 ou 5083-3884
		</address>
		<address>
			E-mail: contato.newWork@alura.com.br
		</address>
	</footer>
